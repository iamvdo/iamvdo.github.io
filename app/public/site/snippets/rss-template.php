...
<rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:wfw="http://wellformedweb.org/CommentAPI/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:atom="http://www.w3.org/2005/Atom">
  ...
  <channel>
    ...
    <link><?php echo $site->full_url(); echo (isset($link)) ? xml($link) : xml(url()) ?></link>
    <lastBuildDate><?php echo (isset($modified)) ? date('r', $modified) : date('r', $site->modified()) ?></lastBuildDate>
    <atom:link href="<?php echo $site->full_url(); echo xml(thisURL()) ?>" rel="self" type="application/rss+xml" />
