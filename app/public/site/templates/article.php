...
<body>
	...
	<section class="main article" role="main">
		...
		<div class="wrap">
			...
			<p class="flattr"><?php echo l::get('flattr-text') ?> <a class="flattr-link" href="https://flattr.com/submit/auto?user_id=z5wn9l&url=<?php echo thisUrl() ?>"><?php echo l::get('flattr-link') ?></a></p>
